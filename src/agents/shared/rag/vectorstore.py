...
class DocumentStore:
    ...
    DOCUMENT_SOURCES = [
        {"path": "docs/de-para/sankhya", "glob": "*.md", "desc": "Mapeamento tabelas"},
        {"path": "docs/investigacoes", "glob": "*.md", "desc": "Investigacoes"},
        {"path": "docs/bugs", "glob": "*.md", "desc": "Bugs conhecidos"},
        {"path": "docs/agentes", "glob": "*.md", "desc": "Specs agentes"},
        {"path": "docs/wms", "glob": "*.md", "desc": "Documentacao WMS"},
        {"path": "docs/api", "glob": "*.md", "desc": "Documentacao API"},
        {"path": "queries", "glob": "**/*.sql", "desc": "Queries SQL"},
        {"path": "output/divergencias", "glob": "*.txt", "desc": "Divergencias"},
    ]
